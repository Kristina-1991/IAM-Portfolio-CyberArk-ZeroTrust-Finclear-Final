...
I extracted 850 high-privilege accounts → the perfect basis for reconciliation with Workday and detection of orphans.
...
### SQL - Reconciliation AD ↔ Workday 
For the reconciliation, I loaded the AD export and the Workday HR export into temporary SQL tables.
Then I did a LEFT JOIN on EmployeeID to find every account that has no matching employee (orphans), has a generic name like “svc_” or “admin” (shared accounts), or hasn’t logged in for over 90 days (stale).

**Result:** exactly the 150 generic/orphan and 213 stale accounts that justified the whole CyberArk programme.

All the evidence is in the repo "CSV files, SQL script, and final inventory report".

![image_alt](https://github.com/Kristina-1991/IAM-Portfolio-CyberArk-ZeroTrust-Finclear-Final/blob/97d169f6fad2df28e4d926f27489f8862a43988c/4_Documents%20%26%20diagrams/SQL_1_query.png?raw=true) 

![image_alt](https://github.com/Kristina-1991/IAM-Portfolio-CyberArk-ZeroTrust-Finclear-Final/blob/5ec8e82defd9ce577e4f829134ecfe893b182889/4_Documents%20%26%20diagrams/SQL_2_query.png?raw=true)
...
- 100 % of privileged accounts with permanent rights → introduction of JIT elevation + dual approval workflow (BR-02)
