...
1. Download the BPMN file : [Performing session AS IS ](../4_Documents%20&%20diagrams/Perform_Windows_server_AS_IS.bpmn)
...
1. Download the BPMN file : [Session recording TO BE](../4_Documents%20&%20diagrams/Session_recording_for_privileged_accounts_TO_BE.bpmn)
2. Open this simulator : https://bpmn-io.github.io/bpmn-js-token-simulation/modeler.html
3. Drag and drop the BPMN file
4. Click on "token simulation"
5. Click on the "trigger event"
